...
about engineering choices instead of just "Chromium vs WebKitGTK." Measured
on this machine (16GB RAM), both freshly launched, both sitting idle at their
login screen, summing RSS across every process each app spawned:
